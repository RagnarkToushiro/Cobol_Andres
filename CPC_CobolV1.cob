       ...
       3200-PREPARAR-CUADRO.
           ...
           *> ESCRIBIR ENCABEZADOS EN ARCHIVO
           ...
           MOVE " " TO REG-SALIDA
           WRITE REG-SALIDA
           MOVE "Cuota | Saldo Inicial   | Valor Cuota | Capital    | Interes  | Saldo Final" 
             TO REG-SALIDA
           WRITE REG-SALIDA
           MOVE "------|----------------|-------------|------------|----------|------------" 
             TO REG-SALIDA
           ...
           DISPLAY "Cuota Saldo Inicial   Valor Cuota   Capital     Interes     Saldo Final"
       ...
       3230-MOSTRAR-CUOTA-00.
           *> MOSTRAR LA CUOTA 00 CON EL VALOR ORIGINAL
           MOVE WS-MONTO-SOLICITADO TO WS-DISPLAY-SALDO
           MOVE 0 TO WS-DISPLAY-CUOTA
           MOVE 0 TO WS-DISPLAY-CAPITAL
           MOVE 0 TO WS-DISPLAY-INTERES
           MOVE WS-MONTO-SOLICITADO TO WS-DISPLAY-SALDO
