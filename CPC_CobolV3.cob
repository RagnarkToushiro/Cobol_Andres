...
3210-CALCULAR-CUOTA.
    *> Calcular interés mensual
    ...
    COMPUTE WS-CAPITAL-AMORT ROUNDED =
    ...
    *> Ajustar última cuota
    IF WS-CUOTA-ACTUAL = WS-CANT-CUOTAS
        ...
        COMPUTE WS-VALOR-CUOTA = WS-CAPITAL-AMORT + WS-INTERES-CUOTA
    ELSE
    ...
    COMPUTE WS-SALDO-FINAL ROUNDED =
        WS-SALDO-INICIAL - WS-CAPITAL-AMORT

    *> Ajustar saldo final para que sea 0 en la última cuota
    IF WS-CUOTA-ACTUAL = WS-CANT-CUOTAS
    ...
    COMPUTE WS-TOTAL-INTERESES ROUNDED =
        WS-TOTAL-INTERESES + WS-INTERES-CUOTA.

3220-MOSTRAR-CUOTA.
    *> Aplicar redondeo personalizado (sin decimales)
    MOVE WS-VALOR-CUOTA TO WS-VALOR-REDONDEAR
    PERFORM 3260-REDONDEAR-VALOR
...
3240-MOSTRAR-RESUMEN.
    ...
    *> Aplicar redondeo final a los totales
...
3260-REDONDEAR-VALOR.
    *> Redondear según reglas específicas (>=50 centavos suma 1)
